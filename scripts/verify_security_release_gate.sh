...
check_unit_file() {
    ...
    require_exact_line "$path" "UMask=0077"
    ...
    require_exact_line "$path" "ProtectClock=true"
    require_exact_line "$path" "ProtectHostname=true"
    require_exact_line "$path" "ProtectControlGroups=true"
    require_exact_line "$path" "ProtectKernelTunables=true"
    require_exact_line "$path" "ProtectKernelModules=true"
    require_exact_line "$path" "ProtectKernelLogs=true"
    require_exact_line "$path" "MemoryDenyWriteExecute=true"
    require_exact_line "$path" "RestrictRealtime=true"
    require_exact_line "$path" "RestrictSUIDSGID=true"
    require_exact_line "$path" "RestrictNamespaces=true"
    require_exact_line "$path" "LockPersonality=true"
    require_exact_line "$path" "SystemCallArchitectures=native"
    require_exact_line "$path" "CapabilityBoundingSet="
    require_exact_line "$path" "RestrictAddressFamilies=AF_UNIX"
    require_exact_line "$path" "RemoveIPC=true"
}
